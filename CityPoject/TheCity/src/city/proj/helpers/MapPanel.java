		...
		if (agent.mapOfPlaces != null) {
			...
			for (int x = 0; x < agent.mapOfPlaces.length; x++) {
				for (int y = 0; y < agent.mapOfPlaces[0].length; y++) {
					...
					if (place != null) {
						if (place.getName().split("_")[1].equals("street")) {
							g.setColor(Color.GRAY);
						} else if (place.getName().split("_")[1].equals("abandoned")) {
							g.setColor(Color.DARK_GRAY);
						} else if (place.getName().split("_")[1].equals("workshop")) {
							g.setColor(Color.ORANGE);
						} else if (place.getName().split("_")[1].equals("factory")) {
							g.setColor(Color.RED);
						} else if (place.getName().split("_")[1].equals("foodstore")) {
							g.setColor(Color.CYAN);
						} else if (place.getName().split("_")[1].equals("jewelrystore")) {
							g.setColor(Color.MAGENTA);
						} else if (place.getName().split("_")[1].equals("bank")) {
							g.setColor(Color.YELLOW);
						} else if (place.getName().split("_")[1].equals("researchinstitute")) {
							g.setColor(Color.CYAN);
						} else if (place.getName().split("_")[1].equals("shoppingmall")) {
							g.setColor(Color.PINK);
						} else if (place.getName().split("_")[1].equals("square")) {
							g.setColor(Color.LIGHT_GRAY);
						} else if (place.getName().split("_")[1].equals("park")) {
							g.setColor(Color.GREEN);
						} else if (place.getName().split("_")[1].equals("policedepartment")) {
							g.setColor(Color.BLUE);
						} else if (place.getName().split("_")[1].equals("casino")) {
							g.setColor(new Color(122, 81, 39));
						} else if (place.getName().split("_")[1].equals("office")) {
							g.setColor(new Color(35, 70, 97));
						} else if (place.getName().split("_")[1].equals("house")) {
							g.setColor(new Color(245, 245, 220));
						} else if (place.getName().split("_")[1].equals("apartment")) {
							g.setColor(new Color(2, 33, 84));
						}
